...
import jp.co.futurenavigator.ptk.ap.api.logic.bridge.service.AnalizeLogicBridgeService;

@RequestMapping("/analizeLogicBridge")
@RestController
public class AnalizeLogicBridgeController {

	/** REST通信呼び出し用Bean設定 */
	@Autowired
	private AnalizeLogicBridgeService service;
