...
import jp.co.futurenavigator.ptk.ap.api.logic.bridge.service.ReplyLogicBridgeService;

@RequestMapping("/replyLogicBridge")
@RestController
public class ReplyLogicBridgeController {

	/** REST通信呼び出し用Bean設定 */
	@Autowired
	private ReplyLogicBridgeService service;
