package jp.co.futurenavigator.ptk.ap.api.logic.bridge.controller;
...
import jp.co.futurenavigator.ptk.ap.api.logic.bridge.service.MemorizeLogicBridgeService;

@RequestMapping("/memorizeLogicBridge")
@RestController
public class MemorizeLogicBridgeController {

	/** REST通信呼び出し用Bean設定 */
	@Autowired
	private MemorizeLogicBridgeService service;
